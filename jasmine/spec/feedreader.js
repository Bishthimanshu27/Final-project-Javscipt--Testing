...
$(function () {
    ...
    describe('The menu', function () {
        ...
        it('should hide the menu by default', function () {
            expect(body.getAttribute('.menu-hidden')).toBeDefined();
        });
        ...
        it('should show menu when click the menu icon link and hide the menu when click again', function () {
            menuButton.click();
            expect(body.getAttribute('.menu-hidden')).toBeDefined("show menu");

            menuButton.click();
            expect(body.getAttribute('.menu-hidden')).toBeDefined('menu-hidden');
        });
        ...
        describe('Initial Entries', function () {
            ...
            it('should ensures when the loadFeed function is called and completes its work,there is at least a single .entry element within the .feed container ', function () {
                expect(document.querySelector('.feed').getAttribute('.entry')).not.toBe(0);
            });
            ...
            describe('New Feed Selection', function () {
                ...
                it('should load new feed', function (done) {
                    var newFeedHtml = document.querySelector('.feed')
                    expect(newFeedHtml).not.toBe(false);
                    done();
                });
            });
        })
